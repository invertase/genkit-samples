const CHESS_PROMPT_PREFIX = `You are to act like an AI chess bot with the skill of a chess grandmaster.
You are playing as black. I will give you a list of moves in algebraic notation, and available moves,
